...
<html lang="en">
	...
	<body>
		<header id="header">
			...
			<div id="head_content">
				<div id="head_content_div" class="content_div">
					<h2 class="flex-head">OUR SERVICES</h2>
					<h3 class="flex-head" style="color: #37392E;">Web Development</h3>
					<div id="services" class="flex-container">
						<img src="images/Services_webdev.png">
						<div class="details">
							<div class="service">
								<h2>New Domain</h2>
		...
		<main id="main">
			...
			<div class="content_div" id="other-systems">
				<h3 class="flex-head">Other Software-Based Systems</h3>
				<div class="flex-container">
					<img src="images/Services_others.png">
					<div class="details">
							<div class="service">
